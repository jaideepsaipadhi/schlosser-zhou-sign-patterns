...
ok=all((k%8==0 and h%8 in (3,5))==(res[(h,k)][0]<res[(h,k)][1]) for (h,k) in res)
print('growing <=> (8|k and h = 3,5 mod 8):',ok)
print('growing cusps all of type (2,6):',all(res[c]==(2,6) for c in grow))
